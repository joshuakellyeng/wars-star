...
class Empire extends StarFighter {
    ...
    fireEmp() {
        xWing.hull -= this.emp
        if(xWing.hull > 0) {
            console.log(`Empire Pilot ${this.pilot}: I'll wipe you off the face of the Galaxy! Rebel Trash! R2:${xWing.hull} can't take anymore damage!`)
        } else {
    ...
    death() {
        console.log(`Empire Pilot ${bowTieFighter.pilot} : GAAAAAAAAAAAAAAAAAAAAAHHHHH!----------disconnected-----------`)
    }
}
...
class Rebel extends StarFighter {
    ...
    death() {
        console.log(`Commander${this.pilot}: Master Kenobi tell Padme I lo-*static noises* beep beep beeep ----------disconnected-----------`)
    }
}
...
dogFight = () => {
 xWing.pilot = prompt("Thank you for volunteering to be a guardian of Tatooine young Commander! What may we call you?")
 console.log(`Well we appreciate your service Commander ${xWing.pilot}, I apologize for the brief introductions but, we've received reports Empire troops extorting citizens entering our skies. Look! There's one now!`)
